...
enum bgp_linkstate_tlv {
	...
	BGP_LS_SPF_TLV_Sequence_Number = 1181,
	BGP_LS_SPF_TLV_SPF_Status = 1184,
	BGP_LS_SPF_TLV_AF_Link_Descriptor = 1185,
...
extern int bgp_nlri_parse_bgpls_spf(struct peer *peer, struct attr *attr,
				   struct bgp_nlri *packet, int withdraw);
